...
class Admin extends CI_Controller
{
    ...
    public function qr_recode_excel_download()
    {
        ...
        $table_columns = array("NO.", "Registration No.", "ID(E-mail)", "국내/국외", "Country", "KSSO 회원 여부", "Name", "소속",  "부서", "네임택용 소속", "Phone Number", "Type of Participation", "Occupation", "Category", "Date of Birth", "대한의사협회 평점신청", "의사면허번호", "전문의번호", "내과전공의 외부학술회의 평점신청 여부", "한국영양교육평가원 평점신청 여부", "영양사자격번호", "임상영양사자격번호", "운동사 평점신청 여부","내과분과전문의 시험/갱신 평점신청 여부", "내과전문의 면허번호", "결제상태", "등록비", "결제일", "결제 방식", "등록 메모", "Satellite Symposium", "Welcome Reception", "Day 2 Breakfast", "Day 2 Luncheon","Day 3 Breakfast", "Day 3 Luncheon", "Special Request for Food" , "Where did you get the information about the conference?", "remark1", "remark2", "remark3", "remark4", "memo", "Day 1 참석여부", "Day 1 입실 시간", "Day 1 퇴실 시간", "체류시간", "Break 제외 시간", "Day 2 참석여부", "Day 2 입실 시간", "Day 2 퇴실 시간", "체류시간", "Break 제외 시간", "Day 3 참석여부", "Day 3 입실 시간", "Day 3 퇴실 시간", "체류시간", "Break 제외 시간");
        ...
        foreach ($list as $row) {
            ...
            $object->getActiveSheet()->setCellValueByColumnAndRow(43, $excel_row,  $row['qr_chk_day_1']);
            $object->getActiveSheet()->setCellValueByColumnAndRow(44, $excel_row, date("H:i", strtotime($row['mintime_day1'])));  //DAY1입실
            $object->getActiveSheet()->setCellValueByColumnAndRow(45, $excel_row, date("H:i", strtotime($row['maxtime_day1'])));  //DAY1퇴실
            $object->getActiveSheet()->setCellValueByColumnAndRow(46, $excel_row, $row['d_format_day1']);                //DAY1체류시간
            $object->getActiveSheet()->setCellValueByColumnAndRow(47, $excel_row, hoursandmins($spent1));

            $object->getActiveSheet()->setCellValueByColumnAndRow(48, $excel_row,  $row['qr_chk_day_2']);
            $object->getActiveSheet()->setCellValueByColumnAndRow(49, $excel_row, date("H:i", strtotime($row['mintime_day2'])));  //DAY2입실
            $object->getActiveSheet()->setCellValueByColumnAndRow(50, $excel_row, date("H:i", strtotime($row['maxtime_day2'])));  //DAY2퇴실
            $object->getActiveSheet()->setCellValueByColumnAndRow(51, $excel_row, $row['d_format_day2']);                          //DAY2체류시
            $object->getActiveSheet()->setCellValueByColumnAndRow(52, $excel_row, hoursandmins($spent2));

            $object->getActiveSheet()->setCellValueByColumnAndRow(53, $excel_row,  $row['qr_chk_day_3']);
            $object->getActiveSheet()->setCellValueByColumnAndRow(54, $excel_row, date("H:i", strtotime($row['mintime_day3'])));  //DAY3입실
            $object->getActiveSheet()->setCellValueByColumnAndRow(55, $excel_row, date("H:i", strtotime($row['maxtime_day3'])));  //DAY3퇴실
            $object->getActiveSheet()->setCellValueByColumnAndRow(56, $excel_row, $row['d_format_day3']);        //DAY3체류시간
            $object->getActiveSheet()->setCellValueByColumnAndRow(57, $excel_row, hoursandmins($spent3));
